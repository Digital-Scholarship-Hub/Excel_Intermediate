## Love Data Week 2026 Version:

When you join the workshop, please download the data by clicking on the following link and clicking "view raw" or the "download" button: [Access Data](https://github.com/Digital-Scholarship-Hub/Excel_Intermediate/blob/main/IntermediateExcel_LDW_2026.xlsx). Open the dataset. Click "enable editing" in the yellow ribbon. You can follow along or just watch the demonstration.

Here is the link to the step-by-step guide, so there should not be a need to take notes during the workshop: [Step-by-step guide](https://github.com/Digital-Scholarship-Hub/Excel_Intermediate/blob/main/LDW_2026_IntermediateExcelGuide.pdf).
